package com.jpabook.jpashop.repository.order.query.dto;
...
public class OrderQueryDto {
    ...
    public void setOrderItemQueryDtos(List<OrderItemQueryDto> orderItemQueryDtos) {
