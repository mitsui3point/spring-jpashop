...
public class OrderSimpleQueryServiceTest extends OrderTestDataField {
    @Autowired
    private OrderSimpleQueryService orderSimpleQueryService;
    @Autowired
    ...
    void 주문전체_회원_배송_DTO_조회() throws JsonProcessingException {
        ...
        //when
        String actual = mapper.writeValueAsString(orderSimpleQueryService.findOrderDtos());
